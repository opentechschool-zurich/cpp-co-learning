...
public:
    ...
    void setName(const std::string& squareName);
...
int main() {
    Square square; // prints "A dog has been constructed"
    square.setName("Barkley");
    square.setWidth(10);
    square.print(); // prints "Dog is Barkley and weighs 10 kg"
    return 0;
