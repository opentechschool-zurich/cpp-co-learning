...
#undef minor
    ...
    struct Arc : Shape {
        Arc(Point centerPoint, int radius, double startAngle, double endAngle) // center and radius
        : mRadius{radius}, mStartAngle{startAngle}, mEndAngle{endAngle}
        {
            add(Point{centerPoint.x - mRadius, centerPoint.y - mRadius});
        }
        ...
        Point center() const {
            return
            {
                point(0).x + mRadius, point(0).y + mRadius
            };
        }
