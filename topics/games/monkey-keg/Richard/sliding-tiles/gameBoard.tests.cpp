...
TEST(GameBoard, possibleMovesIsSolvedIn1Move) {
    std::string game [GameBoard::boardSize][GameBoard::boardSize]{"├", " ", "┫", " ",
        " ", "-", " ", " ",
        " ", " ", " ", " ",
        " ", " ", " ", " "};
    ...
    std::vector<SlidingTiles::MoveNode> possibleMoves = gameBoard.possibleMoves();
    ASSERT_THAT(possibleMoves.size(), 4);
    std::vector<Solution> solutions = gameBoard.solutions(possibleMoves);
...
TEST(GameBoard, isSolvedIn2SingleMoves) {
    std::string game [GameBoard::boardSize][GameBoard::boardSize]{" ", " ", " ", " ",
        " ", "-", " ", " ",
        "├", " ", "┫", " ",
        " ", "-", " ", " "};
...
TEST(GameBoard, addPossibleMoves) {
    ...
    gameBoard.addPossibleMoves(moveNode, 1);
    ASSERT_THAT(moveNode.possibleMoves.size(), 4);
}

TEST(GameBoard, addPossibleMoves3Deep) {
    ...
    // now the addPossibleMoves stuff
    gameBoard.addPossibleMoves(moveNode, 3);
    //std::cout << "---\n" << moveNode.toString() << "----\n";
    ASSERT_THAT(moveNode.possibleMoves.size(), 4);
...
TEST(GameBoard, isSolvedIn1Move) {
    std::string game [GameBoard::boardSize][GameBoard::boardSize]{"├", " ", "┫", " ",
        " ", "-", " ", " ",
        " ", " ", " ", " ",
        " ", " ", " ", " "};
    ...
    ASSERT_TRUE(gameBoard.hasASolution(rootNode)) << "There should be at least one solution for this puzzle";
}

TEST(GameBoard, isSolvedIn2Moves) {
    std::string game [GameBoard::boardSize][GameBoard::boardSize]{"├", " ", "┫", " ",
        " ", " ", " ", " ",
        " ", "-", " ", " ",
        " ", " ", " ", " "};
...
TEST(GameBoard, noSolution) {
    ...
    rootNode.endingBoard = gameBoard.serialiseGame();
    gameBoard.addPossibleMoves(rootNode, 3);
    ASSERT_FALSE(gameBoard.hasASolution(rootNode)) << "There should be at no solution for this puzzle";
}
