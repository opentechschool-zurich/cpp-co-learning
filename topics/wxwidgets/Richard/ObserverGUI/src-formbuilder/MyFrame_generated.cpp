...
MyFrame_generated::MyFrame_generated( wxWindow* parent, wxWindowID id, const wxString& title, const wxPoint& pos, const wxSize& size, long style ) : wxFrame( parent, id, title, pos, size, style )
{
	...
	bSizer5->Add( m_textCtrlPrice, 0, wxALL, 5 );
	...
	bSizer5->Add( m_textCtrlHigh, 0, wxALL, 5 );
	...
	bSizer5->Add( m_textCtrlLow, 0, wxALL, 5 );
	...
	bSizer5->Add( m_textCtrlAverage, 0, wxALL, 5 );
	
	
	bSizer1->Add( bSizer5, 1, wxEXPAND, 5 );
	
	m_chartPanel = new wxPanel( this, wxID_ANY, wxDefaultPosition, wxDefaultSize, wxTAB_TRAVERSAL );
	bSizer1->Add( m_chartPanel, 1, wxEXPAND | wxALL, 5 );
